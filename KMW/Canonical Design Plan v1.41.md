...
- `src/kmw1/evaluation/evaluate.py` — inference path, deterministic decode, native-frame assignment, proxy metrics, routed evaluation, and CSV/JSON summary generation
...
- the canonical-frame proxy/evaluation outputs,
