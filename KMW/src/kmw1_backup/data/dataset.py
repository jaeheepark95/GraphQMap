...
from kmw1.preprocessing.pipeline import load_or_build_preprocessed_sample
...
class KMW1Dataset(Dataset):
    """
    Manifest-driven dataset for the canonical-hardware branch.

    Returned tensors:
    - A, m
    - B_can, c1_can, c2_can, D_can
    - native raw loss tensors: D_raw_nat, e1q_nat, ero_nat, e2q_nat
    - native normalized hardware tensors for diagnostics: B_nat, c1_nat, c2_nat, D_nat
    - p, p_inv
    - n1q, nmeas
    - metadata
    """
    ...
    def __init__(
        ...
        *,
        ...
        self.backend_tensors = backend_tensors or load_or_build_backend_tensors(
