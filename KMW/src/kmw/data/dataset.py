...
# - Extended dataset returns to include the v1.4.1 loss/evaluation tensors:
#     * D_raw, e1q, ero, e2q, n1q, nmeas
# - Kept the model-side native tensors unchanged: A, m, B, c1, c2, D.
# - Metadata flow remains manifest-driven and native-frame only.
# =============================================================================
...
class KMWDataset(Dataset):
    ...
    - A, m, B, c1, c2, D: model-side native tensors
    - D_raw, e1q, ero, e2q: raw backend tensors for loss/evaluation
    - n1q, nmeas: logical operation-count vectors for loss/evaluation
...
def kmw_collate_fn(batch: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    tensor_keys = ["A", "m", "B", "c1", "c2", "D", "D_raw", "e1q", "ero", "e2q", "n1q", "nmeas"]
