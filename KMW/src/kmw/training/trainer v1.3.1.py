    ...
    def train_one_batch(self, batch: Dict, step_idx: int, num_steps_in_epoch: Optional[int]) -> Dict:
        ...
        if stage == "pretrain":
            ...
            metrics = {
                ...
                "passA_L_task": None,
                "passA_L_pst_proxy_1q": None,
                "passA_L_pst_proxy_2q": None,
                "passA_L_pst_proxy_total": None,
                "passA_L_swap": None,
                "passA_L_depth": None,
                "passB_skipped": True,
                "passB_L_task": None,
                ...
                "passB_L_pst_proxy_1q": None,
                "passB_L_pst_proxy_2q": None,
                "passB_L_pst_proxy_total": None,
                "passB_L_swap": None,
                "passB_L_depth": None,
