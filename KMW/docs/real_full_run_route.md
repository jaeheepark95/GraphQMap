...
# -----------------------------------------------------------------------------
# 5) held-out validation: QASMBench (ROUTED FINAL EVAL)
# -----------------------------------------------------------------------------
...
python -m kmw.cli.main eval \
  ...
  --save-routed-qasm-dir "$ROUTED_QASM_DIR/qasmbench_val" \
  --save-routed-qpy-dir "$ROUTED_QPY_DIR/qasmbench_val"
...
python -m kmw.cli.main eval \
  ...
  --seed-transpiler 20260324 \
  --include-readout-in-pst \
  --save-routed-qasm-dir "$ROUTED_QASM_DIR/qasmbench_test" \
  --save-routed-qpy-dir "$ROUTED_QPY_DIR/qasmbench_test"
